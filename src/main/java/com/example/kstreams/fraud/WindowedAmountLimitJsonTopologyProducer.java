...
public class WindowedAmountLimitJsonTopologyProducer {
    ...
    Logger log = Logger.getLogger(WindowedAmountLimitJsonTopologyProducer.class);
    ...
    @Inject
    public WindowedAmountLimitJsonTopologyProducer(@ConfigProperty(name = "sourceTopic") String sourceTopic, @ConfigProperty(name = "validTopic") String validTopic, @ConfigProperty(name = "invalidTopic") String invalidTopic) {
