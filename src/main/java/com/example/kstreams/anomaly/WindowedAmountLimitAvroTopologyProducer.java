...
public class WindowedAmountLimitAvroTopologyProducer {

    static int maxAmount = 100;
    static long windowDurationMs = 10000;
    static long graceDurationMs = 1000;

    Logger log = Logger.getLogger(WindowedAmountLimitAvroTopologyProducer.class);
    ...
    public Topology createTopology(String sourceTopic, String validTopic, String invalidTopic) {
        ...
        // why we do nto define the kind of window here?
        // bc it's implicitly a tumbling window - we do not define the advance in the factory method
